...
const ObcTxRxDiffchart = ({ graphOption, graphOptionValue,currentTab }) => {
...
useEffect(() => {
    ...
    if (graphOption === 'live') {
        interval = setInterval(() => {
            const url = 'api/v2/troubleshoot/obc/netstats';
...
useEffect(() => {
    let url = '';
    if (graphOption === 'live') {
        url = 'api/v2/troubleshoot/obc/netstats';
    } else {
          if(currentTab === 'transcoder'){
            url =`api/v2/nodes/transcoder/${nodeDataId}?${graphOptionValue}&att=rx_bytes,tx_bytes`;
         }else if(currentTab === 'trainradio'){
            url =`api/v2/nodes/suradio/${nodeDataId}?${graphOptionValue}&att=rxrate,txrate`;
        }
...
export default ObcTxRxDiffchart;
