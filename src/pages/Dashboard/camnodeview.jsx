...
import CamConfigurationTab from "./camsummary";

const CamNodeDetails = () => {
          ...
          <article className="row boxsizeng">
            <article className="col-md-12" style={{ paddingRight: 0 }}>
              ...
              <ul className="nodelist">
                <li><a>Node View</a></li>
                <li><a href={`http://${nodeItemDt.ipAddress}` || nodeIpaddress || ipValue} target="_blank">{nodeItemDt.ipAddress || nodeIpaddress || ipValue}</a></li>
